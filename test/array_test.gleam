...
pub fn encode_inline_number_array_test() {
  gleam_toon.encode(Array([Number(1.0), Number(2.0), Number(3.0)]))
...
pub fn encode_inline_quoted_strings_test() {
  gleam_toon.encode(Array([String("hello world"), String("foo, bar")]))
  |> should.equal("[2]: hello world,\"foo, bar\"")
}

pub fn decode_inline_quoted_strings_test() {
  gleam_toon.decode("[2]: hello world,\"foo, bar\"")
  |> should.be_ok
...
pub fn encode_tabular_array_test() {
  ...
  let result = gleam_toon.encode(arr)
...
pub fn encode_single_element_array_test() {
  gleam_toon.encode(Array([Number(42.0)]))
  |> should.equal("[1]: 42")
}

pub fn decode_single_element_array_test() {
  gleam_toon.decode("[1]: 42")
  |> should.be_ok
...
pub fn encode_array_with_empty_strings_test() {
  gleam_toon.encode(Array([String(""), String("a"), String("")]))
  |> should.equal("[3]: \"\",a,\"\"")
}

pub fn decode_array_with_empty_strings_test() {
  gleam_toon.decode("[3]: \"\",a,\"\"")
  |> should.be_ok
